...
function Home(){
 ...
 let reg=await  Api.methods.register(Accounts[getAddress],pass).send({from:Accounts[getAddress],gas:1000000})
    ...
    return(
       ...
       <div className="container">
             ...
             <form className="formcontainer" onSubmit={(e)=>e.preventDefault()}>
                 ...
                 <input type="password" placeholder="PASSWORD" className="input-box margin-10"  onChange={(e)=>{setpass(e.target.value)}}/><br/>
                 <input type="submit" value="register" className="button-1" onClick={Submit} />
                 <h1>your id is:{id}</h1>
