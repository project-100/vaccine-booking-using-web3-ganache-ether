...
async function vaccinedetails(date){
    let detail = await Api.methods.availble(date).call();
    return detail;

}

export default  {Getbookings,GetUserBookings,getStaff,getstaffcount,getstaffcredential,vaccinedetails,calculateTime};
